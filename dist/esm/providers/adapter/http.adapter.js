...
export var ConfigKeyAuth = 'authentication';
export var ConfigKeyAdapter = 'http';
export var HttpAdapterOptionsToken = new OpaqueToken('HTTPADAPTEROPTIONS');
export var HttpAdapter = (function (_super) {
    ...
    HttpAdapter.ctorParameters = [
        ...
        { type: undefined, decorators: [{ type: Optional }, { type: Inject, args: [HttpAdapterOptionsToken,] },] },
    ];
    return HttpAdapter;
}(AdapterOptions));
