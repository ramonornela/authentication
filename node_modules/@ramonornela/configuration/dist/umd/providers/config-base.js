(function (factory) {
    ...
    exports.ConfigToken = new core_1.OpaqueToken('CONFIGTOKEN');
    exports.EnvToken = new core_1.OpaqueToken('ENVTOKEN');
    exports.CustomLoaderToken = new core_1.OpaqueToken('CUSTOMLOADERTOKEN');
