...
export declare abstract class Metadata {
    ...
    abstract setParams(id: string, params: Array<{
        [name: string]: Params;
    }>): this;
    abstract addParam(id: string, param: {
        [name: string]: Params;
    }): this;
    abstract getParams(id: string): {
        [name: string]: Params;
    };
    abstract setHeaders(id: string, headers: Array<{
        [key: string]: any;
    }>): this;
    abstract addHeader(id: string, param: {
        [name: string]: Params;
    }): this;
    abstract getHeaders(id: string): {
        [key: string]: any;
    };
